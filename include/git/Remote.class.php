 ...
 * @subpackage Git
 */
class GitPHP_Remote extends GitPHP_Ref
{
	...
	{
		parent::__construct($project, 'remotes', $head, $headHash);
	}
	 ...
	 *
	 * @param GitPHP_Remote $a first head
	 * @param GitPHP_Remote $b second head
	...
	{
		return 'project|' . $proj . '|commit|' . $head;
	}
